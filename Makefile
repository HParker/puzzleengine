default:
	...
	gcc -lncurses -g -o parseTest puzzle.tab.c lex.yy.c puzzleData.c debugRender.c parseTest.c `pkg-config --cflags --libs ncurses check`
	gcc -lncurses -g -o runnerTest puzzle.tab.c lex.yy.c puzzleData.c debugRender.c runner.c runnerTest.c `pkg-config --cflags --libs ncurses check`
